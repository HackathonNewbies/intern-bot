import { defineChannelTool, isChannelDeliveryTerminatedError, Message, Section, type ChannelMessage, type ChannelToolContext, type InteractionContext } from '@copilotkit/channels';
import { z } from 'zod';
import { proposeCalendarInvite } from '../calendar/tool';
import { proposeAvailableCalendarInvite } from '../calendar/available-tool';
import { CALENDAR_INSTRUCTIONS } from '../prompt';
